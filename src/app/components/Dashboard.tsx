...
const categories = [
  ...
  { name: "Plataformas Educacionais", icon: Tv, color: "bg-purple-500" },
  { name: "Cursos", icon: PlayCircle, color: "bg-red-500" },
  ...
  { name: "Desafios", icon: Trophy, color: "bg-orange-500" },
  { name: "Comunidades", icon: Users, color: "bg-green-600" },
